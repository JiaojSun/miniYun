...
Page({
  ...
  onLoad: function (options) {
    ...
    db.collection('timetable').where({
      ...
      this.setData({
        dataList: JSON.parse(JSON.stringify(res.data[0]))
      });
      console.log('edit');
      ...
      this.setData({
        ...
        fromTime: this.data.dataList.fromTime, 
        toTime: this.data.dataList.toTime, 
        min: this.data.dataList.long,
        indexStu: this.data.dataList.indexStu,
        multiArray: this.data.dataList.multiArray,
        multiIndex: this.data.dataList.multiIndex,
        students: this.data.dataList.dataStudents,
        indexStu: this.data.dataList.indexStu,
        level: this.data.dataList.level,
        fingering: this.data.dataList.fingering, 
        tune: this.data.dataList.tune, 
  ...
  formSubmit(e) {
    ...
    const db = wx.cloud.database();
    db.collection('timetable').doc(this.data._id).update({
      data,
      success: res => {
